...
Route::prefix('/v1')->group(function () {
    ...
    Route::post('salon/getRecommenedSalons', [SalonController::class, 'getRecommenedSalons']);
    Route::post('salon/getSalonsNearby', [SalonController::class, 'getSalonsNearby']);
    Route::post('salon/getFreelancersNearby', [SalonController::class, 'getFreelancersNearby']);
    Route::get('category/getAllCategories', [CategoryController::class, 'getActiveItem']);
    Route::get('category_type/getAllCategories', [CategoryTypeController::class, 'getActiveItem']);
    ...
    Route::post('freelancer_services/getByCategoryTypeId', [ServicesController::class, 'getByCategoryTypeId']);
